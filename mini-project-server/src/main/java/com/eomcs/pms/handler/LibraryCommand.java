...
public class LibraryCommand implements Command {
  ...
  public void execute(PrintWriter out, BufferedReader in) {
    String item = "case 1) 책장 2)의자 3)램프";
    ...
    out.println("-------------------------------------------------------------------------------------------------");
    out.println("무엇을 할까? 1) 책장 2)의자 3)램프");
    out.println("");
    out.println("살펴보려면 " + item + "복도로 이동하려면 /move/hallway");
    out.println("");
    ...
    switch (item) {
      ...
      case "2" :
        out.print("오래된 저택에 있을 법한 생김새를 가진 의자는 낡았지만, 여전히 푹신하다."
          + "다리부터 등받이, 바닥까지 살펴보았지만, 눈에 띄는 점은 없다."); break;
      case "3" :
      ...
      out.println("-----------------------");
      out.println("[살인마의 기록 #2 - content : 앨범을 만들어볼까?] 를 가방에 넣었다. /item/add");
        break;
    }
    out.println(1);
    out.println(2);
